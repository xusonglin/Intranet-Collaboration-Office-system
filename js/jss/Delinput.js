...
//alert(222222222);//2011-10-23增加利于以后可以进行修改  设计页面提交前讲值传到表单中
...
//return true ;
	...
	function addProduct(name,Font_Names,Font_Size,ForeColor,fold)
		{
...
//   label .disabled ="disabled";
  ...
  label.ondblclick= Delinput;
  //label.attachEvent("dblclick",tishi);
...
countcreat++;
 ...
 function Dblclick_()
    ...
    alert(type);
       ...
       var o=document.getElementById("Text_0");
