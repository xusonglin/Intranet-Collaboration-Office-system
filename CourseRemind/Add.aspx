<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="JiaoShiXinXiTongJi.CourseRemind.Add" %>
...
<body>
        ...
        <table border="0" style="background-color: #BCD1EB; margin: 5px;" width="99%">
            <tr>
                ...
                <td class="tdWidtha table_title">
                    添加值<font style="font-weight: 500;"></font>
                </td>
            </tr>
            <tr>
                <td class="tdBlue">
    ...
    <div style="width: 100%; text-align: center;">
        <asp:Button ID="Save" runat="server" Text=" 保 存 添 加 " OnClick="Save_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
